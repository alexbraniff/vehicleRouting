...
implements java.io.Serializable, java.lang.Cloneable {
	...
	private double travelDist; //distance from source to destination
	private int   travelDays;	//no. of days a truck travels to make delivery
	...
	private boolean isTagged;	    //true if visited during a search
	private String truckTypeNeeded;

	private boolean isNotRouted; //true if the shipment has not been routed
	...
	//starting and ending locations of the shipments
	protected String originCity,originState,originZip;
	protected String destCity, destState, destZip;
   ...
   for (int i = 0; i < noComb; i++){
	...
	public void setNotRouted(boolean isNotRouted) {
		this.isNotRouted = isNotRouted;
	}
