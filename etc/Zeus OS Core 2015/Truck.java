...
/**
 ...
 public void setMainRoadSegments (RoadSegmentsLinkedList rsll) {
  ...
  /**
   * Returns whether a truck is compatible with a shipment
  ...
  /**
   * Returns whether or not the vehicle is empty
  ...
  public boolean isEmptyMainNodes() {
    //if ( (mainNodes == null) || (mainNodes.getSize() <= 2)) {
	  //if ( (mainNodes.getHead().getNext() == mainNodes.getTail()) || (mainNodes.getSize() <= 2)) {
	  if ( (mainNodes.getHead().getNext() == mainNodes.getTail())) {	
      return true;
    }
    else {
      return false;
  ...
  public boolean isEmptyMainDays() {
    ...
    if ( (mainDays.getHead().getNext() == mainDays.getTail())) {
      return true;
    }
    else {
      return false;
