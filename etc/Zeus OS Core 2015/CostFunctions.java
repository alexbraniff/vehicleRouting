...
public interface CostFunctions {
  ...
  /**
   * Returns the total number of stips made by the route
   *
   * @param o
   * @return
   */
  ...
  /**
   * must return the total distance traveled by the given object
   *
   * @param o
   * @return
   */
  ...
  /**
   * must return the total days traveled by the given object
   *
   * @param o
   * @return
   */
  ...
  /**
   * Sets the total number of stops made by the route
   *
   * @param o
   */
  ...
  /**
   * sets the total travel days associated with the object. This method may need to make
   * use of other methods to retrieve the required travel days alues.
   *
   * @param o
   */
