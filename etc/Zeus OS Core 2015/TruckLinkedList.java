...
//the method was previously called insertLast
  ...
  public Truck find(int truckNum) {
    Truck currentTruck = head.getNext();

    while (currentTruck != tail) {
  ...
  public Truck getLastTruck() {
    Truck truck = this.getHead().getNext();
  ...
  public Truck removeTruck(Truck truck) {
    Truck tempTruck = head.getNext();
    Truck prevTruck = null;
    Truck nextTruck = null;

    while (tempTruck != tail) {
