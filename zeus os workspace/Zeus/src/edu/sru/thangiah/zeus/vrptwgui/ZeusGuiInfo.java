...
public class ZeusGuiInfo {
  ...
  public static VRPTWDepotLinkedList mainDepots; // The DepotLinkedList passed into the GUI
  ...
  public static String aboutWindowTitle = "About ZeusVRPTWGui";
  ...
  public static String AboutLabel1 = "ZeusVRPTWGui: A Visual Interface for the Zeus VRP Program.";
