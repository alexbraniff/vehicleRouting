...
public class ShipmentFrame
  ...
  private JTree makeTree(ShipmentLinkedList s) {
    ...
    VRPTWShipment shipment = (VRPTWShipment) s.getHead();
    String shipInfo = "";
    ...
    while (shipment != null) {
      ...
      shipInfo = "#" + shipment.getIndex() + "(" + shipment.getXCoord() + "," +
          ...
          shipment.getDemand() + " | Serv. Time: " + 
          shipment.getDuration() + " | Early: " + 
          shipment.getEarly() + " | Late: " + 
          shipment.getLate() + " | Prev: " + prevIndex +
          " | Next: " + nextIndex;
