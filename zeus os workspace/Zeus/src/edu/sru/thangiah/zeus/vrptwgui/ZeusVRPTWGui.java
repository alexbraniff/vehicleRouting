...
public class ZeusVRPTWGui
   ...
   */
  public ZeusVRPTWGui(String filename, VRPTWDepotLinkedList mD, ShipmentLinkedList mS) {
    //run the JFrame constructor
    //super("Zeus - Unified Model for Vehicle Routing Problems");
   ...
   * @param info String
   */
  public ZeusVRPTWGui(VRPTWDepotLinkedList mD, ShipmentLinkedList mS, double[] SFC, String info) {
    //run the JFrame constructor
    super("Zeus - Unified Model for Vehicle Routing Problems");
 ...
 public void setGUITitle(String title) {
  ...
  /*public static void main(String[] args) {
    new ZeusVRPTWGui(null, null, null);
  }*/
}
