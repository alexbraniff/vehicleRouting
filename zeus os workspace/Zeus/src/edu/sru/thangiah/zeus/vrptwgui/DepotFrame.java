        ...
        while (tempDepot != d.getTail()) {
            ...
            while (tempTruck != tempDepot.getMainTrucks().getTail()) {
                if (!tempTruck.isEmptyMainNodes()) {
                    ...
                    VRPTWNodes point = (VRPTWNodes) tempTruck.getMainNodes().getHead().getNext();
                    ...
                    while (point != tempTruck.getMainNodes().getTail()) {
                      ...
                      pointInfo = "#" + point.getIndex() + "(" + point.getShipment().getXCoord() + "," +
                    		  point.getShipment().getYCoord() + ") | Demand: " +
                    		  point.getDemand() + " | Serv. Time: " + 
                    		  point.getServiceTime() + " | Early: " + 
                    		  point.getEarly() + " | Late: " + 
                    		  point.getLate() + " | Begin: " +
                    		  (int) point.getBeginTime() + " | Prev: " + prevIndex +
                              " | Next: " + nextIndex;

                      DefaultMutableTreeNode tempPNode = new DefaultMutableTreeNode(pointInfo);
                      tempTNode.add(tempPNode);
                      point = (VRPTWNodes) point.getNext();
                    }
