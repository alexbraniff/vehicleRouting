      ...
      for (int i = 0; i < depots; i++) {
        ...
        for (int j = 0; j < numTrucks; j++) {
          ...
          for (int k = 1; k < numNodes+1; k++) {
            ...
            n.setServiceTime(Integer.parseInt(st.nextToken().trim()));
            n.setEarly(Integer.parseInt(st.nextToken().trim()));
            n.setLate(Integer.parseInt(st.nextToken().trim()));
            n.setBeginTime(Integer.parseInt(st.nextToken().trim()));
